...
The Harmonized Landsat and Sentinel-2 (HLS) dataset is a NASA product that combines imagery from Landsat 8/9 and Sentinel-2A/B into a single, consistent surface reflectance record. 
The data are processed to align spatial resolution (30 m), spectral bands, and radiometric calibration, while also correcting for differences in acquisition time, geometry, and atmospheric conditions. 
This harmonization provides frequent observations (every 2–3 days globally) with high spatial detail, making it especially useful for tracking vegetation dynamics, land cover change, water resources, 
and agricultural monitoring. Researchers and practitioners rely on HLS because it balances the strengths of both missions—Landsat’s long historical record and Sentinel-2’s finer revisit cycle—into 
a continuous, analysis-ready dataset.
...
We will look at Granule T12SVE for two dates:
...
* Open ENVI 5.6 or higher

> **Note** These Directions are for ENVI 6.0 but depending on the version of ENVI that you are running, some of the tools may be in slightly different places.
...
> **Note**: If you are running a different version of ENVI you will not have a *display* tab, you simply scroll down to the band name section of the edit header window.
...
* (optional) you can try changing how the data is displayed by switching from *2% linear* to *Gaussian* or others.
Personally I find the *square root* works best. You can also adjust the brightness and contrast if you so desire. 
...
**We use `band01` for the L30 data instead of `B01` for S30, so its easier to differentiate the files we are using.**


**Rename L30 bands** *Edit Header File*

Band 1(Coastal_Aerosol:HLS.L30.T12SVE.2019282T180335.v2.0.B01.tif) = **band01 Coastal Aerosol**

Band 2(Blue:HLS.L30.T12SVE.2019282T180335.v2.0.B02.tif) = **band02 Blue**

Band 3(Green:HLS.L30.T12SVE.2019282T180335.v2.0.B03.tif) = **band03 Green**

Band 4(Red:HLS.L30.T12SVE.2019282T180335.v2.0.B04.tif) = **band04 Red**

Band 5(NIR:HLS.L30.T12SVE.2019282T180335.v2.0.B05.tif) = **band05 NIR**

Band 6(SWIR1:HLS.L30.T12SVE.2019282T180335.v2.0.B06.tif) = **band06 SWIR 1**

Band 7(SWIR2:HLS.L30.T12SVE.2019282T180335.v2.0.B07.tif) = **band07 SWIR 2**

NO BAND 8

Band 8(Cirrus:HLS.L30.T12SVE.2019282T180335.v2.0.B09.tif) = **band09 Cirrus**

Band 9(TIRS1:HLS.L30.T12SVE.2019282T180335.v2.0.B10.tif) = **band10 TIRS1**

Band 10(TIRS2:HLS.L30.T12SVE.2019282T180335.v2.0.B11.tif) = **band11 TIRS2**
