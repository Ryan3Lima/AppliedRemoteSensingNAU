...
> Then select the metadata file *LC08_L2SP_037035_20210608_20210615_02_T1_MTL.txt*  and *Open with* Notepad
...
> Now that we have checked the Metadata and everything looks as expected lets **Calibrate the Images**

> We will calibrate each image **One-at-a-time**
